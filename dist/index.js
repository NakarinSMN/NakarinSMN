...
var CONFIG = {
  success: {
    icon: /* @__PURE__ */ jsxRuntime.jsx(bs.BsCheckCircleFill, { className: "text-white text-lg" }),
    iconBg: "bg-green-500",
    bar: "bg-green-500"
  },
  warning: {
    icon: /* @__PURE__ */ jsxRuntime.jsx(bs.BsExclamationTriangleFill, { className: "text-white text-lg" }),
    iconBg: "bg-amber-400",
    bar: "bg-amber-400"
  },
  error: {
    icon: /* @__PURE__ */ jsxRuntime.jsx(bs.BsExclamationCircleFill, { className: "text-white text-lg" }),
    iconBg: "bg-red-500",
    bar: "bg-red-500"
  },
  info: {
    icon: /* @__PURE__ */ jsxRuntime.jsx(bs.BsInfoCircleFill, { className: "text-white text-lg" }),
    iconBg: "bg-blue-500",
    bar: "bg-blue-500"
  }
};
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: `flex-shrink-0 w-9 h-9 rounded-full ${iconBg} flex items-center justify-center`, children: icon }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "text-xs text-gray-400 font-medium", children: [
              seconds,
              "s"
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "font-semibold text-sm text-gray-800 truncate", children: title || LABEL[type] })
          ] }),
          message && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xs text-gray-500 mt-0.5 truncate", children: message })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "button",
          {
            ...
            "aria-label": "\u0E1B\u0E34\u0E14",
            children: /* @__PURE__ */ jsxRuntime.jsx(bs.BsX, { className: "text-white text-base" })
          }
        )
      ]
    }
  ...
  return reactDom.createPortal(
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        "aria-live": "polite",
        "aria-atomic": "false",
        children: toasts.map((toast) => /* @__PURE__ */ jsxRuntime.jsx(Toast, { ...toast, onClose }, toast.id))
      }
    ),
    document.body
  );
...
var ICON_CONFIG = {
  success: {
    icon: /* @__PURE__ */ jsxRuntime.jsx(bs.BsCheckCircleFill, { className: "text-white text-4xl" }),
    bg: "bg-green-500",
    ring: "ring-green-100"
  },
  warning: {
    icon: /* @__PURE__ */ jsxRuntime.jsx(bs.BsExclamationTriangleFill, { className: "text-white text-4xl" }),
    bg: "bg-amber-400",
    ring: "ring-amber-100"
  },
  error: {
    icon: /* @__PURE__ */ jsxRuntime.jsx(bs.BsExclamationCircleFill, { className: "text-white text-4xl" }),
    bg: "bg-red-500",
    ring: "ring-red-100"
  },
  info: {
    icon: /* @__PURE__ */ jsxRuntime.jsx(bs.BsInfoCircleFill, { className: "text-white text-4xl" }),
    bg: "bg-blue-500",
    ring: "ring-blue-100"
  },
  question: {
    icon: /* @__PURE__ */ jsxRuntime.jsx(bs.BsQuestionCircleFill, { className: "text-white text-4xl" }),
    bg: "bg-purple-500",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(
            "div",
            {
              ...
              children: [
                customIcon ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex items-center justify-center", children: customIcon }) : iconCfg ? /* @__PURE__ */ jsxRuntime.jsx(
                  "div",
                  {
                    className: [
                ...
                /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "text-center", children: [
                  /* @__PURE__ */ jsxRuntime.jsx("h2", { id: "smn-modal-title", className: "text-lg font-bold text-gray-800", children: title }),
                  subtitle && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm text-gray-500 mt-1", children: subtitle })
                ] }),
                children && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "w-full", children }),
                buttons && buttons.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex gap-3 w-full mt-2", children: buttons.map((btn, i) => /* @__PURE__ */ jsxRuntime.jsx(
                  "button",
                  {
                    onClick: btn.onClick,
...
var SpeedDial = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `relative flex ${isVertical ? "flex-col" : "flex-row"} items-center ${sz.gap}`, children: [
    actions.map((action, i) => {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
            tooltip && action.label && (direction === "up" || direction === "down") && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-xs font-semibold bg-gray-800 text-white rounded-md px-2 py-1 whitespace-nowrap shadow", children: action.label }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                onClick: () => {
            ...
            tooltip && action.label && (direction === "left" || direction === "right") && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-xs font-semibold bg-gray-800 text-white rounded-md px-2 py-1 whitespace-nowrap shadow", children: action.label })
          ]
        },
        i
      );
      ...
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(
          "span",
          {
            ...
            children: mainIcon ?? /* @__PURE__ */ jsxRuntime.jsx(bs.BsPlus, {})
          }
        )
      }
    )
